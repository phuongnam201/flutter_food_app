...
/**test method autocomplete textfield another */

  // setLocation(LatLng latLng, String address) {
  //   _pickPosition = Position(
  ...
  //   _pickPlacemark = Placemark(name: address);
  //   _changeAddress = true;
  //   // Kiểm tra xem _mapController có khả dụng không trước khi di chuyển bản đồ
  //   if (!_mapController.isNull) {
  //     // Di chuyển camera đến tọa độ mới
  //     _mapController.animateCamera(
  //       CameraUpdate.newCameraPosition(
  //         CameraPosition(
  //           target: latLng,
  //           zoom: 17, // Bạn có thể điều chỉnh mức độ zoom tùy thích
  //         ),
  //       ),
  //     );
  //   }
